	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary static-top">
		<div class="container">
			...
			<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a class="nav-link"href="main"><img src="assets/voltar.png" style="width:50px;height:50px;" title="Voltar" alt="Voltar"></a></li>
			</ul>
		...
		<div class="card-body">
			<form action="insert">
				<div class="mb-3">
					...
					<input type="text" name="nome_tec" placeholder="Digite o nome técnico do medicamento" class="form-control" required>
				</div>
				<div class="mb-3">
					
					<label class="form-label">Nome Comercial</label> 
					
					<input type="text" name="nome_com" placeholder="Digite o nome comercial" class="form-control" required>
				</div>
				
				<div class="mb-3">
					<label class="form-label">Nome do Fabricante</label> 
					<input type="text" name="nome_fab" placeholder="Digite o nome do Fabricante" class="form-control" required>
				</div>
